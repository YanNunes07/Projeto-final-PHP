                    ...
                    <div class="card">
                        <div class="card-image">
                            ...
                            <div class="input-field col s12">
                                ...
                                <input placeholder="Senha:" type="password" class="validate" name="txtsenha" class="validate">
                            ...
                            <div class="input-field col s12" style="padding-left: 32%;" style=" background-color:black;">
                                ...
                                <a href="../view/cadastro.test.php">
                                    <input class="btn btn-warning" type="reset" name="btnLimpar" value="Fazer cadastro"></a>
                            </div>
                </fieldset>
            </div>
